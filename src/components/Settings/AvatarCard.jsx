...
const AvatarCard = ({ avatar, setAvatar }) => {
	return (
		<div className="p-4 mb-4 bg-white border border-gray-200 rounded-lg shadow-sm xl:col-span-1 dark:border-gray-700 sm:p-6 dark:bg-gray-800">
            ...
            <ModalButton title="Upload" buttonIcon={uploadSVG()}/>
						<button
							type="button"
